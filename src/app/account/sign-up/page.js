                ...
                <section className={` container px-12 `}>
                    <div class="p-8 ">
                        <div className={` ${styles.welcome}`}>
                            <h2 class={`  text-center ${druk.className} `}>
                                Create an account
                            </h2>
                            {/* btn */}
                        ...
                        <div className="form-section mt-5 px-14">
                            <form class="space-y-4 md:space-y-6" action="#">
                                ...
                                <button type="submit" class="w-full text-white bg-primary-100 hover:bg-orange focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Create an account</button>
                                <div className="sign-up-sec mt-10 text-center">
                                    <div className="create-account">
                                        <p>
                                        Already have an account? <Link href="/account/login"><span className='text-orange underline font-bold'>
